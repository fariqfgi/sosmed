          ...
          <div id="nav-tab-card" class="tab-pane fade show active">
            <form role="form" action="/post/{{ $post->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" name="tulisan" placeholder="Tulisan" required class="form-control" value="{{ $post->tulisan }}">
              </div>
              <div class="form-group">
                <label for="caption">Caption</label>
                <input type="text" name="caption" placeholder="Caption" required class="form-control" value="{{ $post->caption }}">
              </div>
             
              
               <div class="form-group">
                <label for="quote">Quote</label>
                <input type="text" name="quote" placeholder="Quote dong!" required class="form-control" value="{{ $post->quote }}">
              </div>
